...
import { B as LoaderCircle, Ct as BellRing, Et as ArrowRight, F as Maximize2, I as MapPin, N as MessageCircleQuestionMark, T as Pencil, _ as ShieldCheck, _t as ChevronLeft, f as Star, g as ShoppingBag, gt as ChevronRight, j as MessageSquarePlus, lt as Clock3, m as Sparkles, n as Zap, pt as CircleCheck, r as X, s as Truck, t as ZoomIn, tt as Flame, x as RotateCcw, yt as Check } from "../_libs/lucide-react.mjs";
...
import { n as WishlistButton, t as ProductCard } from "./ProductCard-DCV5pOR_.mjs";
import { t as Input } from "./input-DYHYoj49.mjs";
import { t as Label } from "./label-B4PTMSG2.mjs";
import { t as Textarea } from "./textarea-Du_uAGq3.mjs";
import { c as getProductReviewsServerFn, l as submitReviewServerFn, o as askQuestionServerFn, s as getProductQuestionsServerFn } from "./questions-KEXUjY6G.mjs";
import { t as lookupPincode } from "./pincode.functions-CM2nuP3h.mjs";
import { i as AccordionTrigger, n as AccordionContent, r as AccordionItem, t as Accordion } from "./accordion-DMoxE41r.mjs";
import { n as Route, t as QuantityStepper } from "./product._slug-DNjx_ymz.mjs";
import { n as useRecentlyViewed, t as RecentlyViewed } from "./RecentlyViewed-CvixAm3K.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/product._slug-MBkZzbZH.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function ProductImageZoom({ images, activeImage, onSelectImage, productName, formatLabel, isBestseller, isGlutenFree, thumbContainerRef }) {
	...
	const nextImage = (0, import_react.useCallback)(() => {
	...
	const prevImage = (0, import_react.useCallback)(() => {
		if (images.length <= 1) return;
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					isHovering && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "w-2.5 h-2.5 rounded-full bg-primary ring-2 ring-white shadow-xs" })
						})
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "absolute top-3 left-3 flex flex-wrap gap-1.5 z-10 pointer-events-none",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "rounded-full bg-card/95 backdrop-blur px-2.5 py-0.5 text-[9px] sm:text-[10px] font-bold text-foreground uppercase border border-border/60 shadow-xs",
								children: formatLabel
							}),
							isBestseller ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "rounded-full bg-primary px-2.5 py-0.5 text-[9px] sm:text-[10px] font-bold text-primary-foreground uppercase shadow-xs",
								children: "Bestseller"
							}) : null,
							isGlutenFree ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "rounded-full bg-amber-500 text-slate-950 px-2.5 py-0.5 text-[9px] sm:text-[10px] font-bold uppercase shadow-xs",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [images.length > 1 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "bg-foreground/80 backdrop-blur-md text-background px-2.5 py-0.5 rounded-full text-[10px] font-bold shadow-xs pointer-events-none",
							children: [
								activeImage + 1,
								" / ",
								images.length
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "absolute bottom-3 inset-x-3 flex items-center justify-between pointer-events-none z-10",
						children: [images.length > 1 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "flex items-center gap-1.5 bg-white/90 backdrop-blur-md px-3 py-1.5 rounded-full border border-border shadow-xs pointer-events-auto",
							children: images.map((_, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								...
								className: `h-2 rounded-full transition-all duration-300 cursor-pointer ${activeImage === i ? "w-5 bg-primary" : "w-2 bg-foreground/20 hover:bg-foreground/40"}`
							}, i))
						}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "bg-background/90 backdrop-blur px-2.5 py-1 rounded-lg border border-border text-[9px] sm:text-[10px] text-muted-foreground flex items-center gap-1 shadow-xs",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex items-center justify-between px-1 text-xs text-muted-foreground font-medium",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center gap-1.5",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ZoomIn, { className: "h-3.5 w-3.5 text-primary" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Hover to magnify · Click arrows to view next photo" })]
				}), images.length > 1 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					className: "text-[11px] text-muted-foreground/80",
					children: [images.length, " views available"]
				}) : null]
			}),
			images.length > 1 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: images.map((img, i) => {
					...
					return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						className: `relative h-18 w-18 sm:h-20 sm:w-20 shrink-0 overflow-hidden rounded-xl border-2 p-1.5 bg-white transition-all cursor-pointer ${active ? "border-primary shadow-md scale-105 ring-2 ring-primary/30" : "border-border hover:border-primary/60 opacity-75 hover:opacity-100"}`,
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
							src: img,
							alt: `Thumbnail ${i + 1}`,
							className: "h-full w-full object-contain",
							loading: "eager"
						}), active ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "absolute bottom-1 right-1 h-2 w-2 rounded-full bg-primary ring-1 ring-white" }) : null]
					}, img + i);
				})
			}) : null,
			lightboxOpen && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					images.length > 1 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronLeft, { className: "h-7 w-7" })
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						type: "button",
						onClick: (e) => {
							e.stopPropagation();
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronRight, { className: "h-7 w-7" })
					})] }) : null,
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					images.length > 1 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: images.map((img, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
							onClick: () => onSelectImage(i),
							className: `h-14 w-14 rounded-lg overflow-hidden border-2 p-1 bg-white transition-all cursor-pointer ${activeImage === i ? "border-primary scale-105" : "border-white/40 opacity-60 hover:opacity-100"}`,
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
								src: img,
								alt: "",
								className: "h-full w-full object-contain"
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ProductImageZoom, {
							images: gallery,
							activeImage,
