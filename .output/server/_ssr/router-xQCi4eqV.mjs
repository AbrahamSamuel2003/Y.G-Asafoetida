...
import { E as Palette, I as MapPin, L as Mail, P as Menu, Q as Heart, a as UserRound, g as ShoppingBag, ht as ChevronUp, r as X, u as Trash2, vt as ChevronDown, w as Phone, y as Search, yt as Check } from "../_libs/lucide-react.mjs";
import { a as DialogOverlay, c as DialogTrigger, i as DialogDescription, n as DialogClose, o as DialogPortal, r as DialogContent, s as DialogTitle, t as Dialog } from "../_libs/@radix-ui/react-dialog+[...].mjs";
import { t as SmartImage } from "./SmartImage-CZON1jhE.mjs";
import { n as useWishlist, t as WishlistProvider } from "./wishlist-ldWImUuO.mjs";
import { i as products, n as formatPrice } from "./products--El95C0C.mjs";
import { n as useCart, t as CartProvider } from "./cart-CW0VkAaI.mjs";
import { n as toast, t as Toaster } from "../_libs/sonner.mjs";
import { n as OrdersProvider } from "./orders-C0nOgnCU.mjs";
import { n as Route$10 } from "./admin-BPJ35aPB.mjs";
import { t as Route$11 } from "./order-confirmed-CDIYRSjH.mjs";
import { t as Route$12 } from "./order._id-BNsCoVsy.mjs";
import { t as Route$13 } from "./policies._slug-CAjdWI3y.mjs";
import { n as Route$14, t as QuantityStepper } from "./product._slug-DNjx_ymz.mjs";
import { t as QueryClientProvider } from "../_libs/tanstack__react-query.mjs";
import { t as QueryClient } from "../_libs/tanstack__query-core.mjs";
import { n as Root, t as Indicator } from "../_libs/radix-ui__react-progress.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-xQCi4eqV.js
...
var VALID_THEMES = new Set(PALETTE_THEMES.map((t) => t.id));
...
function ThemeProvider({ children }) {
	...
	(0, import_react.useEffect)(() => {
		...
		try {
			...
			if (stored && VALID_THEMES.has(stored)) initial = stored;
		} catch {}
	...
	const cycleTheme = (0, import_react.useCallback)(() => {
		const list = PALETTE_THEMES.map((t) => t.id);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Palette, { className: "h-3.5 w-3.5 text-muted-foreground shrink-0" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "text-xs font-semibold text-foreground whitespace-nowrap",
					children: current.name
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, { className: `h-3 w-3 text-muted-foreground transition-transform duration-200 ${isOpen ? "rotate-180 text-primary" : ""}` })
			]
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "px-2.5 py-1.5 mb-1 flex items-center justify-between border-b border-border/60",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "text-[10px] font-bold uppercase tracking-wider text-muted-foreground",
					children: "Select Color Theme"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "text-[9px] font-semibold text-primary bg-primary/10 px-1.5 py-0.5 rounded-full",
					children: "4 Themes"
				})]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "space-y-1",
				children: PALETTE_THEMES.map((item) => {
					const active = item.id === theme;
					return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						type: "button",
						onClick: () => handleSelect(item.id, item.name),
						role: "menuitem",
						className: `w-full flex items-center justify-between px-3 py-2.5 rounded-xl cursor-pointer transition-all text-left ${active ? "bg-primary/10 border border-primary/30 text-primary shadow-xs" : "hover:bg-muted/70 text-foreground border border-transparent"}`,
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center gap-2.5 min-w-0",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: `h-4 w-4 rounded-full ring-2 ring-white shadow-xs shrink-0 transition-transform ${active ? "scale-110 ring-primary" : ""}`,
							...
							className: "h-5 w-5 rounded-full bg-primary text-primary-foreground flex items-center justify-center shrink-0 ml-2 shadow-xs",
...
var SearchDialog = (0, import_react.lazy)(() => import("./SearchDialog-Btf5y40Z.mjs").then((m) => ({ default: m.SearchDialog })));
var nav = [
	{
		to: "/shop",
		label: "Shop"
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ThemeSwitcher, { className: "inline-flex" }),
...
var $$splitComponentImporter$8 = () => import("./routes-CjiyT7cf.mjs");
...
var $$splitComponentImporter$7 = () => import("./account-DvK-emJN.mjs");
...
var $$splitComponentImporter$6 = () => import("./checkout-D82UO2hR.mjs");
...
var $$splitComponentImporter$5 = () => import("./contact-B64ob_UR.mjs");
...
var $$splitComponentImporter$3 = () => import("./shop-D38_27hR.mjs");
...
var $$splitComponentImporter$2 = () => import("./story-C_9pfZkC.mjs");
...
var $$splitComponentImporter$1 = () => import("./track-D-KynYxH.mjs");
...
var $$splitComponentImporter = () => import("./wishlist-DcJSZLR3.mjs");
