...
import { t as ProductCard } from "./ProductCard-Cer8gEMp.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-DtutiF_R.js
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					}, HERO_VIDEOS[currentVideoIndex].src),
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: Array.from({ length: rev.rating }).map((_, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Star, { className: "h-3 w-3 fill-amber-500 text-amber-500" }, i))
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "text-[9px] px-1.5 py-0.2 bg-primary/10 text-primary font-bold rounded",
									children: "Verified"
								})]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
								className: "mt-2 text-xs font-bold text-foreground leading-snug",
								children: rev.title
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("blockquote", {
								className: "mt-1.5 text-[11px] text-muted-foreground leading-relaxed line-clamp-3",
								children: [
									"“",
									rev.comment,
									"”"
							...
							className: "mt-3 pt-2 border-t border-border/60 flex items-center justify-between text-[10px]",
