...
//#region node_modules/.nitro/vite/services/ssr/assets/ProductCard-CYe909vP.js
...
var QuickViewDialog = (0, import_react.lazy)(() => import("./QuickViewDialog-PPsziw-m.mjs").then((m) => ({ default: m.QuickViewDialog })));
