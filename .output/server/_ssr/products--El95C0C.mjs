//#region node_modules/.nitro/vite/services/ssr/assets/products--El95C0C.js
var products = [
	{
	...
	},
	{
		...
		gallery: ["/products/hing-chips/img-1.jpg", "/products/hing-chips/img-2.jpg"],
	...
	},
	{
		...
		shelfLife: "9 months from packing. Keep jar sealed.",
		variants: [{
			id: "200g",
			label: "200 g",
			price: 135,
	...
	},
	{
		...
		gallery: ["/products/millet-pongal-mix/img-1.jpg", "/products/millet-pongal-mix/img-2.jpg"],
	...
	},
	{
		...
		gallery: ["/products/millet-sambar-mix/img-1.jpg", "/products/millet-sambar-mix/img-2.jpg"],
...
function searchProducts(query) {
	...
	return products.map((p) => {
		...
		let score = 0;
		for (const t of terms) if (p.name.toLowerCase().includes(t)) score += 3;
...
function formatPrice(paise) {
	if (paise === void 0 || paise === null || isNaN(Number(paise))) return "₹0";
	return `₹${Number(paise).toLocaleString("en-IN")}`;
}
//#endregion
export { searchProducts as a, products as i, formatPrice as n, getProduct as r, formatLabels as t };
